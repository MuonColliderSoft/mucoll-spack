...
class K4gaudipandora(CMakePackage, Key4hepPackage):
    ...
    url = "https://github.com/MuonColliderSoft/k4GaudiPandora/archive/v00-11.tar.gz"
    homepage = "https://github.com/MuonColliderSoft/k4GaudiPandora.git"
    git = "https://github.com/MuonColliderSoft/k4GaudiPandora.git"
