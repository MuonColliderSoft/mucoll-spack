...
class K4geo(CMakePackage):
    ...
    homepage = "https://github.com/tmadlener/lcgeo"
    git = "https://github.com/tmadlener/lcgeo.git"
    url = "https://github.com/tmadlener/lcgeo/archive/v00-16-07.tar.gz"
    ...
    version("ZsegPR", branch="zplanar-segmentation-mucoll")
    version(
        "0.20",
