...
class K4geo(CMakePackage):
    ...
    homepage = "https://github.com/madbaron/k4geo"
    git = "https://github.com/madbaron/k4geo.git"
    url = "https://github.com/madbaron/k4geo/archive/v00-16-07.tar.gz"
    ...
    version("fieldmap", branch="MAIA_B_fieldmap")
    version(
        "00-26",
        sha256="dfc2e4a28ac0796016c2e14f3f4bef225ca26f337e5d0069f35b27f8beebb608",
    )
    version(
        "00-25",
