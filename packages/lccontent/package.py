...
class Lccontent(CMakePackage):
    ...
    url = "https://github.com/madbaron/lccontent/archive/v03-01-05.tar.gz"
    homepage = "https://github.com/madbaron/lccontent"
    git = "https://github.com/madbaron/lccontent.git"
    ...
    version("optimisation", branch="fragment_optimisation")
    version(
        "3.2.0",
